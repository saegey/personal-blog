...
<Carousel
  slides={[
    { src: './photos/DSC_0954a.png', alt: 'Public Vinyl Radio home setup' },
    { src: './photos/pvr-record-close.jpg', alt: 'Close-up of a spinning record' },
    { src: './photos/pvr-rapha-live.jpg', alt: 'Rapha Seattle live crowd' },
    { src: './photos/pvr-branding.jpg', alt: 'Branding and one-off merch' },
  ]}
  ratio={16/9}
  autoplayMs={0}
  showDots
...
The real nudge came one Halloween, on the way to *Cumbia de Muertos*. I was dressed as Giorgio Tsoukalos from *Ancient Aliens*, and I joked with friends about starting our own vinyl channel. Both of them work in video professionally and have deep collections, so it wasn't an idle thought — it felt doable.
